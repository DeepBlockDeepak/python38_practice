...
#'visit' contains a list of all the Location() objects read-in from the .csv file within it's self.locations list attribute 
visit = Locations()
...
def locations(category):
  #filtered list of Location() objects; subset of 'visit'
